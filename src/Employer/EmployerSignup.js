...
function CreateEmployer() {
    ...
    const employerSignup = async (e) => {
        ...
        await axios.post(`http://localhost:8000/api/signup-as-employer`, formData).then(({data}) => {
          Swal.fire({
            icon:"success",
            text:data.message
          })
                            ...
                            <div className="row align-items-center mt-5">
                                <div className="col-lg-6">
                                    <div className="section-title mt-4 mt-lg-0">
                                        <h3 className="title">Employer</h3>
                                        <p className="text-muted">Start working with Jobcy that can provide everything you need to generate
                                            awareness, drive traffic, connect.</p>
                                            <br />
                                        <form method="post" onSubmit={employerSignup} className="contact-form mt-4" name="myForm" id="myForm">
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="col-md-6">
                                                    <div className="mb-3">
                                                        <label htmlFor="mobileInput" className="form-label">OTP</label>
                                                        <input type="text" className="form-control" id="mobileInput" name="subject" 
                                            ...
                                            <div className="text-end blockContent">
                                                <button type="submit" id="submit" name="submit" className="btn btn-primary"> Register <i className="uil uil-message ms-1"></i></button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
