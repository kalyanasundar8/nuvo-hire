                            ...
                            <div class="row">
                                <div class="col-lg-8">
                                    <div class="card job-detail overflow-hidden">
                                        ...
                                        <div class="card-body p-4">
                                            <div>
                                                <div class="row">
                                                    <div class="col-md-8">
                                                        <h5 class="mb-1">Product Designer / UI Designer</h5>
                                                        ...
                                                        <ul class="list-inline mb-0 text-lg-end mt-3 mt-lg-0">
                                                            <li class="list-inline-item">
                                                                <div class="favorite-icon">
                                                                    <Link to=""><i class="uil uil-heart-alt"></i></Link>
                                                                </div>
                                                            </li>
                                                            <li class="list-inline-item">
                                                                <div class="favorite-icon">
                                                                    <Link to=""><i class="uil uil-setting"></i></Link>
                                                                </div>
                                                            </li>
                                                        </ul>
                                                    </div>
                                            ...
                                            <div class="mt-4 pt-3">
                                                <ul class="list-inline mb-0">
                                                    ...
                                                    <li class="list-inline-item mt-1">
                                                        <Link to="" class="btn btn-primary btn-hover"><i class="uil uil-facebook-f"></i> Facebook</Link>
                                                    </li>
                                                    <li class="list-inline-item mt-1">
                                                        <Link to="" class="btn btn-danger btn-hover"><i class="uil uil-google"></i> Google+</Link>
                                                    </li>
                                                    <li class="list-inline-item mt-1">
                                                        <Link to="" class="btn btn-success btn-hover"><i class="uil uil-linkedin-alt"></i> linkedin</Link>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-10">
                                                        <div class="mt-3 mt-lg-0">
                                                            <h5 class="fs-17 mb-1"><Link to="/job-detail" class="text-dark">HTML Developer</Link> <small class="text-muted fw-normal">(0-2 Yrs Exp.)</small></h5>
                                                            <ul class="list-inline mb-0">
                                                                <li class="list-inline-item">
                                                ...
                                                <div class="row justify-content-between">
                                                    <div class="col-md-8">
                                                        <div>
                                                            <ul class="list-inline mb-0">
                                                                ...
                                                                <li class="list-inline-item"><Link to="" class="primary-link text-muted">Ui designer</Link>,</li>
                                                                <li class="list-inline-item"><Link to="" class="primary-link text-muted">developer</Link></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="text-md-end">
                                                            <Link to="" class="primary-link">Apply Now <i class="mdi mdi-chevron-double-right"></i></Link>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row justify-content-between">
                                                    <div class="col-md-8">
                                                        <div>
                                                            <ul class="list-inline mb-0">
                                                                <li class="list-inline-item"><i class="uil uil-tag"></i> Keywords :</li>
                                                                <li class="list-inline-item"><Link to="" class="primary-link text-muted">Marketing</Link>,</li>
                                                                <li class="list-inline-item"><Link to="" class="primary-link text-muted">business</Link></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="text-center mt-4">
                                        <Link to="/jobs" class="primary-link form-text">View More <i class="mdi mdi-arrow-right"></i></Link>
                                    </div>
                                    ...
                                    <div class="side-bar ms-lg-4">
                                        <div class="card job-overview">
                                            <div class="card-body p-4">
                                                ...
                                                <div class="mt-3">
                                                    <Link to="#applyNow" data-bs-toggle="modal" class="btn btn-primary btn-hover w-100 mt-2">Apply Now <i class="uil uil-arrow-right"></i></Link>
                                                    <Link to="bookmark-jobs.php" class="btn btn-soft-warning btn-hover w-100 mt-2"><i class="uil uil-bookmark"></i> Add Bookmark</Link>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card company-profile mt-4">
                                            <div class="card-body p-4">
                                                ...
                                                <div class="mt-4">
                                                    <Link to="company-details.php" class="btn btn-primary btn-hover w-100 rounded"><i class="mdi mdi-eye"></i> View Profile</Link>
                                                </div>
                                            </div>
                                        </div>
