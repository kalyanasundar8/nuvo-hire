                                        ...
                                        <div class="page-next">
                                            <nav class="d-inline-block" aria-label="breadcrumb text-center">
                                                <ol class="breadcrumb justify-content-center">
                                                    ...
                                                    <li class="breadcrumb-item active" aria-current="page"> Candidate Grid </li>
                                                </ol>
                                            </nav>
                                        </div>
                                    </div>
                                    ...
                                    <div class="candidate-list-widgets mb-4">
                                        <form action="#">
                                            <div class="row g-2">
                                                ...
                                                <div class="col-lg-3">
                                                    <div>
                                                        <a href="" class="btn btn-primary"><i class="uil uil-filter"></i> Filter</a>
                                                        <a href="" class="btn btn-success ms-2"><i class="uil uil-cog"></i> Advance</a>
                                                    </div>
                                                </div>
                                            </div> {/*end row*/}
                                        </form> {/*end form*/}
                                        ...
                                        <div class="candidate-grid-box bookmark-post card mt-4">
                                            <div class="card-body p-4">
                                                ...
                                                <div class="d-flex mb-4">
                                                    ...
                                                    <div class="ms-3">
                                                       <a href="candidate-details.php" class="primary-link"><h5 class="fs-17">Charles Dickens</h5></a>
                                                        <span class="badge bg-info-subtle text-info fs-13">$800/month</span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mt-3">
                                                    ...
                                                    <a href="candidate-details.php" class="btn btn-soft-primary btn-hover w-100 mt-2"><i class="mdi mdi-eye"></i> View Profile</a>
                                                </div>
                                            </div>
                                        </div>  {/*end card*/}
                                    </div> {/*end col*/}
                                        ...
                                        <div class="candidate-grid-box bookmark-post card mt-4">
                                            <div class="card-body p-4">
                                                <div class="d-flex mb-4">
                                                    ...
                                                    <div class="ms-3">
                                                       <a href="candidate-details.php" class="primary-link"><h5 class="fs-17">Gabriel Palmer</h5></a>
                                                        <span class="badge bg-info-subtle text-info fs-13">$350/hrs</span>
                                                    </div>
                                                </div>
                                                <ul class="list-inline d-flex justify-content-between align-items-center">
                                                    <li class="list-inline-item text-warning fs-17">
                                        ...
                                        <div class="candidate-grid-box card mt-4">
                                            <div class="card-body p-4">
                                                ...
                                                <div class="d-flex mb-4">
                                                    ...
                                                    <div class="ms-3">
                                                       <a href="candidate-details.php" class="primary-link"><h5 class="fs-17">James Lemire</h5></a>
                                                        <span class="badge bg-info-subtle text-info fs-13">$280/hrs</span>
                                                    </div>
                                                </div>
                                                <ul class="list-inline d-flex justify-content-between align-items-center">
                                                    <li class="list-inline-item text-warning fs-17">
                                        ...
                                        <div class="candidate-grid-box card mt-4">
                                            <div class="card-body p-4">
                                                <div class="d-flex mb-4">
                                                    ...
                                                    <div class="ms-3">
                                                       <a href="candidate-details.php" class="primary-link"><h5 class="fs-17">Rebecca Swartz</h5></a>
                                                        <span class="badge bg-info-subtle text-info fs-13">$240/hrs</span>
                                                    </div>
                                                </div>
                                                <ul class="list-inline d-flex justify-content-between align-items-center">
                                                    <li class="list-inline-item text-warning fs-17">
                                        ...
                                        <div class="candidate-grid-box card mt-4">
                                            <div class="card-body p-4">
                                                <div class="d-flex mb-4">
                                                    ...
                                                    <div class="ms-3">
                                                       <a href="candidate-details.php" class="primary-link"><h5 class="fs-17">Betty Richards</h5></a>
                                                        <span class="badge bg-info-subtle text-info fs-13">$198/hrs</span>
                                                    </div>
                                                </div>
                                                <ul class="list-inline d-flex justify-content-between align-items-center">
                                                    <li class="list-inline-item text-warning fs-17">
                                        ...
                                        <div class="candidate-grid-box bookmark-post card mt-4">
                                            <div class="card-body p-4">
                                                <div class="d-flex mb-4">
                                                    ...
                                                    <div class="ms-3">
                                                       <a href="candidate-details.php" class="primary-link"><h5 class="fs-17">Jeffrey Montgomery</h5></a>
                                                        <span class="badge bg-info-subtle text-info fs-13">$299/hrs</span>
                                                    </div>
                                                </div>
                                                <ul class="list-inline d-flex justify-content-between align-items-center">
                                                    <li class="list-inline-item text-warning fs-17">
                                        ...
                                        <div class="candidate-grid-box bookmark-post card mt-4">
                                            <div class="card-body p-4">
                                                <div class="d-flex mb-4">
                                                    ...
                                                    <div class="ms-3">
                                                       <a href="candidate-details.php" class="primary-link"><h5 class="fs-17">Brooke Hayes</h5></a>
                                                        <span class="badge bg-info-subtle text-info fs-13">$310/hrs</span>
                                                    </div>
                                                </div>
                                                <ul class="list-inline d-flex justify-content-between align-items-center">
                                                    <li class="list-inline-item text-warning fs-17">
                                        ...
                                        <div class="candidate-grid-box card mt-4">
                                            <div class="card-body p-4">
                                                <div class="d-flex mb-4">
                                                    ...
                                                    <div class="ms-3">
                                                       <a href="candidate-details.php" class="primary-link"><h5 class="fs-17">Cerys Woods</h5></a>
                                                        <span class="badge bg-info-subtle text-info fs-13">$450/hrs</span>
                                                    </div>
                                                </div>
                                                <ul class="list-inline d-flex justify-content-between align-items-center">
                                                    <li class="list-inline-item text-warning fs-17">
                                        ...
                                        <div class="candidate-grid-box card mt-4">
                                            <div class="card-body p-4">
                                                <div class="d-flex mb-4">
                                                    ...
                                                    <div class="ms-3">
                                                       <a href="candidate-details.php" class="primary-link"><h5 class="fs-17">Olivia Murphy</h5></a>
                                                        <span class="badge bg-info-subtle text-info fs-13">$300/hrs</span>
                                                    </div>
                                                </div>
                                                <ul class="list-inline d-flex justify-content-between align-items-center">
                                                    <li class="list-inline-item text-warning fs-17">
