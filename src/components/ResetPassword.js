...
export default function ResetPassword() {
    ...
    const validationSchema = Yup.object({
        ...
        confirm_password: Yup.string().required('Please enter the confirm password.'),
    });
                                        ...
                                        <div className="auth-content card-body p-5 h-100 text-white">
                                            <div className="w-100">
                                                ...
                                                <form onSubmit={formik.handleSubmit} className="auth-form">
                                                    ...
                                                    <div className="mb-3">
                                                        <label for="usernameInput" className="form-label">Password</label>
                                                        <input
                                                            type="text"
                                                            className="form-control"
                                                            id="usernameInput"
                                                    ...
                                                    <div className="mb-3">
                                                        <label for="usernameInput" className="form-label">Confirm Password</label>
                                                        <input
                                                            type="text"
                                                            className="form-control"
                                                            id="usernameInput"
